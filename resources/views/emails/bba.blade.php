...
<head>
    ...
    <title>Bachelor of Business Administration (BBA)</title>
...
<body>
    <div class="container">
        ...
        <p>Thank you for reaching out and expressing your interest in the Bachelor of Business Administration (BBA) --
            ...
            Chamber of Commerce (UTCC).</p>

        <p>Our BBA program is a 4-year international course with intakes in both August and January.</p>

        <p>For more detailed information about the program, please visit: <a
                href="https://ism.utcc.ac.th/bba-ism/">Program Details</a><br>
